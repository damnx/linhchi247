		...
		switch (post('type')) {
			case 'link':
				...
				$data = array(
					"category"    => "post",
					"type"        => post('type'),
					"url"         => $spintax->process(post('link_url')),
					"image"       => $spintax->process(post('link_picture')),
					"title"       => $spintax->process(post('link_title')),
					"caption"     => $spintax->process(post('link_caption')),
					"description" => $spintax->process(post('link_description')),
			...
			case 'video':
				...
				$data = array(
					...
					"description" => $spintax->process(post('video_description')),
					"message"     => $spintax->process(post('message')),
				);
				break;
			default:
